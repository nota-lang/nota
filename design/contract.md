...
| `<sec-intro>` | `h(Label, { id: "sec-intro" }, [])` (R20 sugar; boundary-guarded — `Vec<T>` stays text) |
| `&sec-intro` | `h(Ref, { id: "sec-intro" }, [])` (R20; boundary-guarded — `R&D` stays text) |
