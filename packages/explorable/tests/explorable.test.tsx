/**
 * Explorable primitives through the SSG driver: the Slider's control markup and readout, the
 ...
 * hydration test, which drives the real built page.
 */
import { NotaDoc, renderDocument } from "@nota-lang/core";
import { createSignal } from "solid-js";
import { describe, expect, test } from "vitest";
import { Action, Slider, Sticky } from "../src/lib";
