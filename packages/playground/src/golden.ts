 ...
 * project's end-to-end golden). The editor seeds from {@link DEFAULT_SNIPPET}, not this — the golden's
 * inline component is a deliberate highlighting edge case (see default-snippet.ts). Kept inline
